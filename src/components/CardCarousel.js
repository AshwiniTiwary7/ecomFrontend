    ...
    <div>
      <section className="homesection2 sectionpadding sectioncolor">
        <div className="container-fluid" style={{padding: "15px"}}>
            <h1 className="text-center productheading">Upcoming Products</h1>
        </div>
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <div className="card-wrapper">
                            ...
                            <div className="card productcards featuredproducts">
                                <img src="https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/images/2006789/2017/9/6/11504677807745-Roadster-Men-Black-Solid-Hooded-Sweatshirt-3471504677807554-1.jpg" className="card-img-top productimage" alt="images" />
                                <div className="card-body text-center productcardbody" style={{color: "black"}}>
                            ...
                            <div className="card productcards featuredproducts">
                                <img src="https://imagescdn.planetfashion.in/img/app/product/5/571704-5044787.jpg?auto=format" className="card-img-top productimage" alt="images" />
                                <div className="card-body text-center productcardbody" style={{color: "black"}}>
                            ...
                            <div className="card productcards featuredproducts">
                                <img src="https://imagescdn.planetfashion.in/img/app/product/7/746060-8401856.jpg?auto=format" className="card-img-top productimage" alt="images" />
                                <div className="card-body text-center productcardbody" style={{color: "black"}}>
                    ...
                    <div className="carousel-item">
                        <div className="card-wrapper">
                            ...
                            <div className="card productcards featuredproducts">
                                <img src="https://assets.ajio.com/medias/sys_master/root/20230624/d2lM/64966b12a9b42d15c9ddccee/-288Wx360H-465410816-burgundy-MODEL.jpg" className="card-img-top productimage" alt="images" />
                                <div className="card-body text-center productcardbody" style={{color: "black"}}>
                            ...
                            <div className="card productcards featuredproducts">
                                <img src="https://www.northbeachboutique.net.au/cdn/shop/products/Sherri-Hill-55041-neon-pink-50511_400x.jpg?v=1681710403" className="card-img-top productimage" alt="images" />
                                <div className="card-body text-center productcardbody" style={{color: "black"}}>
                            ...
                            <div className="card productcards featuredproducts">
                                <img src="https://www.ever-pretty.com/cdn/shop/products/EO03124DN-R6_900x.jpg?v=1669701017" className="card-img-top productimage" alt="images" />
                                <div className="card-body text-center productcardbody" style={{color: "black"}}>
                            ...
                            <div className="card productcards featuredproducts">
                                <img src="https://media1.popsugar-assets.com/files/thumbor/MC5qMySlG8jzSwlgf1ZWTpVA-HE/fit-in/550x550/filters:format_auto-!!-:strip_icc-!!-/2020/03/09/009/n/1922564/2deefeb75e66cd7f573254.08633646_/i/Floral-Dresses-Amazon.jpg" className="card-img-top productimage" alt="images" />
                                <div className="card-body text-center productcardbody" style={{color: "black"}}>
